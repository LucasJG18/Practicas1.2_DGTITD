...
if __name__ == "__main__":
    print("Iniciando Pipeline ETL: Bloque INEC (Semana 3)...\n")
    ...
    # 1. ENEMDU
    # =========================================================================
    print("\n[1/2] Procesando tasas de la ENEMDU...")
    # PARCHE CLAVE: sep=';'
    df_enemdu = pd.read_csv("../data/INEC/2. Tasas.csv", skiprows=2, sep=';', usecols=[1, 2, 3, 4, 5], 
    ...
    print(f"   ENEMDU lista. Filas a inyectar: {len(df_fact_empleo)}")

    # =========================================================================
    # 2. CENSO 2022
    # =========================================================================
    print("\n[2/2] Procesando Censo 2022 (Actividad Economica)...")
    ruta_censo = "../data/INEC/5.1.csv"
    ...
    # Agrupar a nivel de provincia (sumando personas) porque la BD no tiene cantones
