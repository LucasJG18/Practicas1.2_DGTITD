...
if __name__ == "__main__":
    ...
    df_ranking = pd.read_csv("../data/Supercias y MINEDUC/bi_ranking.csv", 
    ...
    df_directorio = pd.read_excel("../data/Supercias y MINEDUC/directorio_companias.xlsx", skiprows=4, engine='openpyxl')
    ...
    try:
        ...
        print("   Datos inyectados con exito en la base de datos.")
